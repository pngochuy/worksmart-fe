...
export const EmployerSidebar = ({ onLinkClick }) => {
    ...
    <>
      <ul className="navigation">
        <li className={checkActive("/employer/dashboard") ? "active" : ""}>
          <NavLink to="/employer/dashboard" onClick={handleLinkClick}>
        ...
        >
          <NavLink to="/employer/subscription-plans" onClick={handleLinkClick}>
        ...
        >
          <NavLink to="/employer/change-password" onClick={handleLinkClick}>
            <i className="la la-lock"></i>Change Password
          </NavLink>
        </li>
        <li className={checkActive("/employer/settings") ? "active" : ""}>
          <NavLink to="/employer/settings" onClick={handleLinkClick}>
