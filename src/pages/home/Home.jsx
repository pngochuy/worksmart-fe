          ...
          <div className="row">
            <div className="content-column col-lg-7 col-md-12 col-sm-12">
              <div className="inner-column">
                ...
                >
                  <ul className="companies-carousel sponsors-carousel-two owl-carousel owl-theme">
                    <li className="slide-item">
                      <figure className="image-box">
                        <a href="#">
                          <img src="images/index-22/client-1.png" alt="" />
                        </a>
                      </figure>
                    </li>
                    <li className="slide-item">
                      <figure className="image-box">
                        <a href="#">
                          <img src="images/index-22/client-2.png" alt="" />
                        </a>
                      </figure>
                    </li>
                  </ul>
            ...
            <div className="image-column col-lg-5 col-md-12">
              <div className="image-box ms-0 mt50">
                ...
                >
                  <img
                    className="w-100"
                    src="images/index-22/home22-hero-img1.png"
                    alt=""
                  />
                </figure>
              </div>
