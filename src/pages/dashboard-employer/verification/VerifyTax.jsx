        ...
        if (user.role === "Employer") {
          ...
          if (data) {
            ...
            if (data.taxVerificationStatus === "Approved") {
              setIsVerified(true);
              setVerificationMessage(
                "Your tax verification has been approved."
              );
            } else if (data.taxVerificationStatus === "Pending") {
              setIsPending(true);
              setVerificationMessage(
                "Your tax verification is pending. Please wait for approval."
              );
            } else if (data.taxVerificationStatus === "Rejected") {
              setVerificationMessage(
                "Your tax verification was rejected. Please submit again."
              );
            }
          }
        }
  ...
  const onSubmit = async (formData) => {
    ...
    try {
      ...
      const errorMessage =
        ...
        "Error submitting tax verification, please try again.";
        ...
        <div className="dashboard-outer">
          <div className="upper-title-box bg-light p-3 rounded mb-4">
            ...
            <div className="text text-secondary">
              Verify your company before post job!
            </div>
          </div>
