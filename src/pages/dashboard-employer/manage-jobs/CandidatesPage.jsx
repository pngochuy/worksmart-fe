  ...
  const getCandidates = async (jobId) => {
    try {
      ...
      if (data.candidates && data.totalPage) {
        ...
        const calculatedTotalPages = Math.ceil(totalItems / searchParams.PageSize);
        ...
        const filteredData = data
          .filter(candidate => 
            !searchParams.name || 
            (candidate.fullName && candidate.fullName.toLowerCase().includes(searchParams.name.toLowerCase()))
          )
          ...
          <div className="search-box-container">
            <div className="search-input-wrapper">
              <input
                ...
                onChange={(e) => setSearchParams({ ...searchParams, name: e.target.value, PageIndex: 1 })}
              />
              ...
              <div className="widget-title">
                ...
                <div className="widget-title-right">
                  <div className="refresh-button">
                    <button className="btn-refresh" onClick={() => getCandidates(jobId)}>
                ...
                {loading ? (
                  ...
                  <div className="table-responsive">
                    <table className="default-table manage-job-table">
                      <thead>
                        <tr>
                          <th><i className="fas fa-user mr-1"></i> Name</th>
                          <th><i className="fas fa-envelope mr-1"></i> Email</th>
                          <th><i className="fas fa-phone mr-1"></i> Phone</th>
                            ...
                            <tr key={candidate.applicationID}>
                              <td>
                                <div className="candidate-name">
                                  ...
                                  <div className="candidate-info">
                                    <span className="name">{candidate.fullName || "Unknown"}</span>
                                  </div>
                                </div>
                              </td>
                              <td>
                              ...
                              <td>
                                {candidate.phoneNumber ? (
                                  <a href={`tel:${candidate.phoneNumber}`} className="phone-link">
                                    {candidate.phoneNumber}
                                  </a>
                                ) : (
                                  "Unknown"
